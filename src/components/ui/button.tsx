...
function Button({
  ...
  return (
    <ButtonPrimitive
      data-slot="button"
      className={cn(buttonVariantsRaw({ variant, size, className }))}
      {...props}
    />
  );
}
...
const buttonVariants = ({
  ...
  variant,
  size,
}: Pick<ButtonPrimitive.Props, "className"> &
  VariantProps<typeof buttonVariantsRaw> = {}) =>
  cn(buttonVariantsRaw({ className, variant, size }));
